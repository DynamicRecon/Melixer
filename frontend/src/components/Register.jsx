...
const Register = () => {
    const [form, setForm]  = useState({username: "", email: "", passowrd:"", confirm: ""});
                ...
                <form onSubmit={handleSubmit}>
                    <div style={{ marginBottom: "16px" }}>
                        ...
                        <input name="username" value={form.username} onChange={handleChange}
                            required style={inputStyle} placeholder="Choose a username" />
                    </div>
                    <div style={{ marginBottom: "16px" }}>
                    ...
                    <div style={{ marginBottom: "16px" }}>
                        ...
                        <input name="password" type="password" value={form.password} onChange={handleChange}
                            required style={inputStyle} placeholder="Choose a password" />
                    </div>
                    <div style={{ marginBottom: "24px" }}>
                        <label style={labelStyle}>Confirm Password</label>
                        <input name="confirm" type="password" value={form.confirm} onChange={handleChange}
                            required style={inputStyle} placeholder="Repeat your password" />
                    </div>
                    <button
                        type="submit"
                        disabled={loading}
...
const labelStyle = {
    ...
    fontSize: "0.88rem", fontWeight: "600", color: "#444"
};
